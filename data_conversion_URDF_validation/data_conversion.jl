...
# FLODER 5: Slow_Exp2_13_12_2024
if(F5)
    # Input data files
    data_in_position = joinpath(@__DIR__, "..", "data", "Slow_Exp2_13_12_2024", "Raw", "Position.txt")
    data_in_velocity = joinpath(@__DIR__, "..", "data", "Slow_Exp2_13_12_2024", "Raw", "Velocity.txt")
    data_in_PWM = joinpath(@__DIR__, "..", "data", "Slow_Exp2_13_12_2024", "Raw", "PWM.txt")
    data_in_current = joinpath(@__DIR__, "..", "data", "Slow_Exp2_13_12_2024", "Raw", "Current.txt")
    ...
    extension_factor = 20                               # Padding between two values
    max_lines = 20001
    Folder = joinpath(@__DIR__, "..", "data", "Slow_Exp2_13_12_2024", "Images")
