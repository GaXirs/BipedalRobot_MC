...
data_out_extended_Torque = joinpath(@__DIR__, "..", "data", "extended_Torque.txt")
# frequency
freq = 20.0
...
extend_data(data_out_Torque, data_out_extended_Torque,0.05,50,max_lines = 10000)
...
plot_data(data_out_Torque, "Position",(5.0,7.0))
